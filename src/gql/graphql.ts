...
export type ProductProductColorVariantArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
  locales?: InputMaybe<Array<Locale>>;
};
...
export type ProductCreateInput = {
  ...
  productColorVariant?: InputMaybe<ProductColorVariantCreateOneInlineInput>;
...
export type ProductSizeVariantCreateInput = {
  ...
  product?: InputMaybe<ProductCreateOneInlineInput>;
  size: ProductSize;
  /** stock input for default locale (en) */
...
export type ProductUpdateInput = {
  ...
  productColorVariant?: InputMaybe<ProductColorVariantUpdateOneInlineInput>;
...
export type ScheduledOperationAffectedDocument = Asset | Category | Collection | Currency | Order | OrderItem | Product | ProductColorVariant | ProductSizeVariant | Review;
...
export type ProductsByCategoryIdQuery = { category?: { id: string, name: string, products: Array<{ id: string, name: string, description: string, price: number, images: Array<{ id: string, url: string }> }> } | null };
...
export type ProductsByNameQuery = { products: Array<{ id: string, name: string, description: string, price: number, images: Array<{ url: string }>, categories: Array<{ id: string, name: string }> }> };
...
export const ProductsByCategoryIdDocument = new TypedDocumentString(`
  ...
  category(where: {id: $id}) {
    ...
    `) as unknown as TypedDocumentString<ProductsByCategoryIdQuery, ProductsByCategoryIdQueryVariables>;
